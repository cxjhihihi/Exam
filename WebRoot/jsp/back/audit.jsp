...
<body onload="message()">
		...
		<aside class="right-side">                
			...
			<section class="content">
				<c:if test="${not empty info }">
					...
					<div align="center">
						<div class="btn-group btn-group-lg" role="group">
							<button type="button" id="adoptButton" class="btn btn-primary" onclick="updateAuditStatus('2', '${info.id}')">审核通过</button>
							<button type="button" id="notAdoptButton" class="btn btn-primary"  onclick="updateAuditStatus('1', '${info.id}')">审核不通过</button>
						</div>
					</div>
				</c:if>
				<c:if test="${empty info }">
					<div align="center">
						<div class="btn-group btn-group-lg" role="group">
							<button type="button" class="btn btn-primary">暂无审核信息</button>
						</div>
					</div>
				</c:if>
			</section>
	...
	<script type="text/javascript" src="js/back/audit.js"></script>
</body>
</html>